...
public class Settings {
    ...
    public static final String ORDER_BY_ID_ASC = MySQLiteOpenHelper.ID + " " + ASC;
    public static final String ORDER_BY_ID_DESC = MySQLiteOpenHelper.ID + " " + DESC;
    ...
    public static String CURRENT_ORDER_BY_CONFIG = ORDER_BY_NAME_ASC;
    /************************************************************************************/
